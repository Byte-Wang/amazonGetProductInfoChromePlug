...
function showInfo(info){
    ...
    style.appendChild(document.createTextNode("\
        ...
        .feixun_plug_col-1 { flex: 0 0 8.333333%; max-width: 8.333333%; }  \
        .feixun_plug_col-2 { flex: 0 0 16.666667%; max-width: 16.666667%; }  \
        .feixun_plug_col-3 { flex: 0 0 25%; max-width: 25%; }  \
        .feixun_plug_col-4 { flex: 0 0 33.333333%; max-width: 33.333333%; }  \
        .feixun_plug_col-5 { flex: 0 0 41.666667%; max-width: 41.666667%; }  \
        .feixun_plug_col-6 { flex: 0 0 50%; max-width: 50%; }  \
        .feixun_plug_col-7 { flex: 0 0 58.333333%; max-width: 58.333333%; }  \
        .feixun_plug_col-8 { flex: 0 0 66.666667%; max-width: 66.666667%; }  \
        .feixun_plug_col-9 { flex: 0 0 75%; max-width: 75%; }  \
        .feixun_plug_col-10 { flex: 0 0 83.333333%; max-width: 83.333333%; }  \
        .feixun_plug_col-11 { flex: 0 0 91.666667%; max-width: 91.666667%; }  \
        .feixun_plug_col-12 { flex: 0 0 100%; max-width: 100%; }  \
        }  \
          @keyframes rotate {\
...
function parserToTitleFeatureDiv(retryTimes){
    ...
    showInfo("\
        <div class=\"feixun_plug_row feixun_plug_bottom_border\">\
            <div class=\"feixun_plug_col-3\"><b>ASIN： </b><span id=\"feixun_plug_asin\">查询中...</span>\
            ...
            <div class=\"feixun_plug_col-3 feixun_plug_text\" style=\"display:flex;\"><b>卖家：</b><span id=\"feixun_plug_soldBy\"><span/></div>\
            <div class=\"feixun_plug_col-3\" ><b>配送：</b><span id=\"feixun_plug_ShipsFrom\"></span></div>\
            <div class=\"feixun_plug_col-3\" ><b>卖家数：</b><span id=\"feixun_plug_soldByNumber\"></span>\
            <img style=\"width: 27px;height: 27px;position: absolute;right: 5px;cursor: pointer;\" id=\"feixun_plug_refresh_img\"\
        ...
        <div class=\"feixun_plug_row\">\
            ...
            <span id=\"feixun_plug_rank\">**</span> in <b><span id=\"feixun_plug_category\"></span></b>\
            </div>\
            <div class=\"feixun_plug_col-6\"><b>评分：</b><span id=\"feixun_plug_ReviewNumber\"></span></div>\
        </div>\
        <div class=\"feixun_plug_row feixun_plug_bottom_border\">\
            <div class=\"feixun_plug_col-6\"><b>品牌：</b><span id=\"feixun_plug_brand\"></span>&nbsp;<span id=\"feixun_plug_brandState\"></span></div>\
            <div class=\"feixun_plug_col-6\"><b>是否在库：</b><span id=\"feixun_plug_checkasin\"></span></div>\
        </div>\
        <div class=\"feixun_plug_row\">\
            <div class=\"feixun_plug_col-3\"><b>FBA费用：</b><span id=\"feixun_plug_totalFba\"></span></div>\
            <div class=\"feixun_plug_col-3\"><b>重量：</b><span id=\"feixun_plug_weight\"></span></div>\
            <div class=\"feixun_plug_col-3\"><b>利润率：</b><span id=\"feixun_plug_profitRate\"></span></div>\
            <div class=\"feixun_plug_col-3\"><b>购物车：</b><span id=\"feixun_plug_amount\"></span></div>\
        </div>\
        <div class=\"feixun_plug_row\">\
            <div class=\"feixun_plug_col-6\" ><b>上架时间：</b><span id=\"feixun_plug_AvailableDate\"></span></div>\
            <div class=\"feixun_plug_col-6\" ><b>ASIN类型：</b><span id=\"feixun_plug_asinType\"></span></div>\
        </div>\
         ");
